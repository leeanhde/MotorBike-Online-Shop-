...
<!--                                -->                                    
                                <form action="Login" class="login-form needs-validation"  method="post">
...
<!--                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="" required name="user" />
...
<!--                                    <div class="form-group">
                                    ...
                                    <div class="form-group button-action clearfix text-center">
                                        <div class="login-forget pull-left">
                                            ...
                                            <a class="forgot-password ml-4" href="resetPassword.jsp">Forgot your password?</a>
                                        </div>

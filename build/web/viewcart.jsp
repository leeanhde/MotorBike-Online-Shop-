<%-- 
    Document   : cart
    Created on : Jun 10, 2023, 12:02:17 AM
    Author     : leede
--%>
                                ...
                                <div class="table-content table-responsive">
                                    <table class="table table-bordered border-0 table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="pro-img text-center"><a href="productdetails.jsp"><img class="img-fluid blur-up lazyload" src="assets/images/products/product-100x100.jpg" data-src="assets/images/products/product-100x100.jpg" alt="image" title="image" width="100" /></a></td>
                                                <td class="pro-del text-center text-sm-left">
                                                    <% HttpSession session = request.getSession(); %>
                                                    <c:forEach items="${sessionScope.listP}" var="p">
                                                    <p class="mb-1 pro-name"><a href="productdetails?id=${p.id}">${p.productName} asdasd</a></p>
                                                    </c:forEach>

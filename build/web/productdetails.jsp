<%-- 
    ...
    Created on : Jun 9, 2023, 10:54:14 PM
    Author     : leede
--%>
...
<html class="no-js" lang="en">
    ...
    <body class="template-product-detail-default sticky-view-product">
        <!-- Start Page Loader -->
        ...
        <div class="main-wrapper cart-drawer-push">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="megamenu submenu dropdown">
                                            <ul>
                                                ...
                                                <li class="dropmenu">
                                                    <a class="item" href="cart">Cart <span class="arw plush" title="Click to show/hide"></span></a>
                                                    <ul class="droplink submenu1">
            ...
            <!-- Start Sticky Product -->
            <div class="sticky-product fadeInDown clearfix">
                <div class="container">
                    <div class="alert alert-dismissible fade show clearfix p-0 m-0 border-0 rounded-0" role="alert">
                        <button type="button" class="sticky-product-close close ti-close" data-dismiss="alert" aria-label="Close"></button>
                        <div class="sticky-product-imfo">
                            <div class="sticky-image">
                                <img class="product-image" src="assets/images/products/sticky-pro-img.jpg" alt="image" title="image" />
                                <div class="product-label"><span class="label soldout">-20%</span></div>
                            </div>
                            <div class="sticky-details">
                                <h3 class="product-title"><a href="product-details.html">Neque porro quisquam dolorem</a></h3>
                                <div class="product-price"><span class="compare-price">$75.20</span><span class="sale-price">$70.15</span></div>
                            </div>
                        </div>

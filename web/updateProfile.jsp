                                ...
                                <div class="account-details col-12 col-sm-9 col-md-9">
                                    <div class="tab-content" id="account-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="my-account-details" role="tabpanel" aria-labelledby="my-account-details-tab">
                                            ...
                                            <form action="updateProfile" class="save-register-form needs-validation" method="POST">
                                                <p>Already have an account? <a href="login.jsp" class="link-color">Log in instead!</a></p>

                                                <div class="form-group col-md-12">
                                                    <label> User ID: </label>
                                                    <input readonly="" type="text" class="form-control" value="${profile.id}" name="id"/>
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label> Name: </label>
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" value="${profile.phoneNum}" name="phoneNum" required />
                                                    <div class="invalid-feedback">Please enter your password.</div>
                                                </div>
                                                <div class="form-group col-md-12"><button onclick="showAlert()" type="submit">Save</button></div>
                                                <script>
                                                    function showAlert() {
                                                        alert("Hãy kiểm tra kỹ trước khi lưu !!");
                                                    }
                                                </script>
